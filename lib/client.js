...
function createMessageActions(runtime) {
  return function MessageActions({ sessionId, payload, message, nativeMessageId, text, role, children, changed }) {
    ...
    return /* @__PURE__ */ import_react3.default.createElement("div", { className: "tavern-message", "data-message-role": role }, editing ? /* @__PURE__ */ import_react3.default.createElement("textarea", { className: "tavern-message-editor", "aria-label": role === "user" ? "\u7F16\u8F91\u7528\u6237\u6D88\u606F" : "\u7F16\u8F91\u6A21\u578B\u6D88\u606F", value: draft, onChange: (event) => setDraft(event.target.value), autoFocus: true }) : children, /* @__PURE__ */ import_react3.default.createElement("div", { className: "tavern-message-actions" }, editing ? /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("button", { disabled, onClick: () => act("edit", draft) }, "\u4FDD\u5B58"), canReroll && role === "user" && /* @__PURE__ */ import_react3.default.createElement("button", { disabled: disabled || !draft.trim(), onClick: () => act("reroll", draft) }, "\u4FDD\u5B58\u5E76\u91CD\u65B0\u751F\u6210"), /* @__PURE__ */ import_react3.default.createElement("button", { disabled: busy, onClick: () => setEditing(false) }, "\u53D6\u6D88")) : /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("button", { disabled, onClick: () => {
      setDraft(content);
      setEditing(true);
  ...
  ctx.slots.inject("conversation.chat.node", () => {
    ...
    return bindComponent(original, (Original) => {
      function Assistant(props) {
        ...
        return /* @__PURE__ */ import_react5.default.createElement(MessageActions, { sessionId: props.sessionId, payload, message: payload.state.messages[messageIndex], nativeMessageId: props.node.data.finalNode?.messageId, role: "assistant", text }, renderText(text, payload, messageIndex, props.sessionId, (content) => /* @__PURE__ */ import_react5.default.createElement(Original, { ...props, node: { ...props.node, data: { ...props.node.data, blocks: [{ kind: "text", text: content }] } } })));
      }
      return Assistant;
    });
  });
