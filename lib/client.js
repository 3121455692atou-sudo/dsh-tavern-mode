...
function createBrowserRuntime(ctx) {
  ...
  async function refreshNow(id, remount = false) {
    ...
    if (!payload.state) {
      publish(id, { payload: null, error: null, loaded: true });
      return;
    }
...
function apply(ctx) {
  ...
  const usePayload = (id) => (0, import_react5.useSyncExternalStore)((callback) => runtime.subscribe(id, callback), () => runtime.get(id));
  function Component({ sessionId, source, index }) {
    ...
    return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, error && /* @__PURE__ */ import_react5.default.createElement("p", { role: "alert" }, error), ready && /* @__PURE__ */ import_react5.default.createElement("iframe", { key: runtimeId, ref, className: "tavern-native-component", title: "\u89D2\u8272\u5361\u524D\u7AEF\u7EC4\u4EF6", allow: "clipboard-write", sandbox: "allow-scripts allow-same-origin allow-modals allow-downloads" }));
  }
  function renderText(text, payload, index, sessionId, native, placement = 2) {
    ...
    text = display.text;
    if (mode === "text") return /* @__PURE__ */ import_react5.default.createElement("pre", { style: { whiteSpace: "pre-wrap", font: "inherit" } }, text);
    ...
    return parts.map((part, key) => part.html !== void 0 ? /* @__PURE__ */ import_react5.default.createElement(Component, { key, sessionId, source: part.html, index }) : /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, { key }, native(part.text)));
  }
  for (const key of ["user", "steering"]) ctx.slots.inject("conversation.chat.node", () => {
    ...
    return bindComponent(original, (Original) => {
      function User(props) {
        ...
        if (preset !== "tavern" || !payload) return /* @__PURE__ */ import_react5.default.createElement(Original, { ...props });
        ...
        if (text === "/tavern-retry-updates") return /* @__PURE__ */ import_react5.default.createElement("p", { className: "tavern-caption" }, "\u91CD\u8BD5\u672A\u5B8C\u6210\u7684\u8868\u683C\u4E0E\u8BB0\u5FC6\u66F4\u65B0");
        ...
        const render = (content) => /* @__PURE__ */ import_react5.default.createElement(Original, { ...props, node: { ...props.node, data: { ...props.node.data, content } } });
        let start = index;
        while (start > 0 && payload.state.messages[start - 1].scriptCreated) start--;
        return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, payload.state.messages.slice(Math.max(0, start), Math.max(0, index)).map((message, offset) => standaloneMessage(message, payload, start + offset, props.sessionId)), /* @__PURE__ */ import_react5.default.createElement(MessageActions, { sessionId: props.sessionId, payload, message: payload.state.messages[index], nativeMessageId: props.node.id, role: "user", text }, renderText(text, payload, index, props.sessionId, (text2) => render([{ type: "text", text: text2 }]), 1), attachments.length > 0 && render(attachments)));
      }
      return User;
    });
  });
  ctx.slots.inject("conversation.chat.node", () => {
    ...
    return bindComponent(original, (Original) => {
      function Assistant(props) {
        ...
        if (props.node.data.status !== "settled") return /* @__PURE__ */ import_react5.default.createElement(Original, { ...props });
        ...
        if (!text) return /* @__PURE__ */ import_react5.default.createElement(Original, { ...props });
        const messageIndex = findMessageIndex(payload.state, props.node.data.finalNode?.messageId, text, "assistant");
        return /* @__PURE__ */ import_react5.default.createElement(MessageActions, { sessionId: props.sessionId, payload, message: payload.state.messages[messageIndex], nativeMessageId: props.node.data.finalNode?.messageId, role: "assistant", text, reasoning: props.node.data.blocks.filter((block) => block.kind === "reasoning").map((block) => block.text ?? "").join("\n") }, renderText(text, payload, messageIndex, props.sessionId, (content) => /* @__PURE__ */ import_react5.default.createElement(Original, { ...props, node: { ...props.node, data: { ...props.node.data, blocks: [{ kind: "text", text: content }] } } })));
      }
      return Assistant;
    });
  });
    ...
    const disposers = ctx.slots.entriesOfSlot("conversation.chat.node").filter((entry) => !["user", "steering", "assistant-step"].includes(entry.options.key)).map((original) => {
      return bindComponent(original, (Original) => {
        function ChatNode(props) {
          ...
          return /* @__PURE__ */ import_react5.default.createElement(Original, { ...props, node: text === void 0 ? props.node : { ...props.node, data: { ...props.node.data, closing: { ...closing, blocks: [{ kind: "text", text }] } } } });
        }
        return ChatNode;
      });
    });
  ...
  function standaloneMessage(message, payload, index, sessionId) {
    return /* @__PURE__ */ import_react5.default.createElement(MessageActions, { key: message.id, sessionId, payload, message, role: message.role, text: message.content }, renderText(message.content, payload, index, sessionId, (text) => /* @__PURE__ */ import_react5.default.createElement(import_dsh_client_ui_primitives.MarkdownText, { text, labels: markdownLabels }), message.role === "user" ? 1 : 2));
  }
  function Opening({ sessionId, payload, blank }) {
    ...
    return /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-opening" }, messages[0]?.greeting && blank && /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-greeting" }, standaloneMessage(messages[0], payload, 0, sessionId)), messages.slice(start).map((message, offset) => standaloneMessage(message, payload, start + offset, sessionId)));
  }
  ctx.slots.inject("conversation.input.dock", () => {
    ...
    return ctx.slots.register({ name: "conversation.input.dock", id: "tavern-toolbar", order: 20, locale: original.locale, inject: original.inject }, function Toolbar(props) {
      ...
      return /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-toolbar" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-toolbar-row" }, /* @__PURE__ */ import_react5.default.createElement(Mode, { ...props, select: (mode) => runtime.changeMode(mode).catch((error) => error.message) }), /* @__PURE__ */ import_react5.default.createElement("select", { "aria-label": "\u73A9\u6CD5", value: payload?.state?.config?.playMode ?? payload?.config?.playMode ?? "agent", onChange: (event) => {
      ...
      } }, /* @__PURE__ */ import_react5.default.createElement("option", { value: "agent" }, "\u591A agent"), /* @__PURE__ */ import_react5.default.createElement("option", { value: "normal" }, "\u666E\u901A")), /* @__PURE__ */ import_react5.default.createElement("button", { className: "tavern-current-card", title: payload?.card.name ?? "\u9009\u62E9\u89D2\u8272\u5361", onClick: () => setModal("cards") }, payload?.card.name ?? "\u89D2\u8272\u5361"), /* @__PURE__ */ import_react5.default.createElement("button", { onClick: () => setModal("resources") }, "\u5BFC\u5165"), /* @__PURE__ */ import_react5.default.createElement("button", { onClick: () => setModal("resources") }, "\u9884\u8BBE"), /* @__PURE__ */ import_react5.default.createElement("button", { onClick: () => setModal("agents") }, (payload?.state?.config?.playMode ?? payload?.config?.playMode) === "normal" ? "\u6700\u5927\u8F93\u5165\u4E0E\u6A21\u578B" : "\u591A agent"), /* @__PURE__ */ import_react5.default.createElement("button", { onClick: () => runtime.script(props.sessionId, "\u53F0\u8BCD\u6846").catch((error) => runtime.report(props.sessionId, error.message)) }, "\u53F0\u8BCD\u6846"), buttons.filter((button) => button.name !== "\u53F0\u8BCD\u6846" && button.name !== "\u5BF9\u8BDD\u6C14\u6CE1").map((button) => /* @__PURE__ */ import_react5.default.createElement("button", { key: button.id, onClick: () => runtime.script(props.sessionId, button.id).catch((error) => runtime.report(props.sessionId, error.message)) }, button.name))), notice && /* @__PURE__ */ import_react5.default.createElement(import_dsh_client_ui_primitives.Toast, { key: notice.id, text: notice.message, holdMs: notice.timeOut === 0 ? 2147483647 : notice.timeOut ?? 3e3, anchor: document.querySelector("[data-composer-card]"), icon: /* @__PURE__ */ import_react5.default.createElement("button", { "aria-label": "\u5173\u95ED\u901A\u77E5", onClick: () => runtime.clearNotice(props.sessionId, notice.id) }, "\xD7"), onDone: () => runtime.clearNotice(props.sessionId, notice.id) }), /* @__PURE__ */ import_react5.default.createElement(import_dsh_client_ui_primitives.Modal, { open: !!modal, onClose: () => setModal(""), title: modal === "cards" ? "\u89D2\u8272\u5361" : "\u672C\u5BF9\u8BDD\u8BBE\u7F6E", closeLabel: "\u5173\u95ED", className: "tavern-settings-dialog" }, modal === "cards" ? /* @__PURE__ */ import_react5.default.createElement(ResourceLibrary, { runtime, sessionId: props.sessionId, selected: () => setModal("") }) : modal && /* @__PURE__ */ import_react5.default.createElement(Settings, { ...props, embedded: true, initialPage: modal, key: modal, scope: "session", sessionId: props.sessionId })));
    });
  });
  ctx.slots.inject("main.conversation", () => {
    ...
    return bindComponent(original, (Original) => {
      function TavernConversation(props) {
        ...
        const shell = (0, import_react5.useRef)(), scroll = (0, import_react5.useRef)(), composer = (0, import_react5.useRef)();
        (0, import_react5.useEffect)(() => {
        ...
        const bar = /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, session && input && props.renderSlot("conversation.input.dock", { session, input }), props.renderSlot("conversation.composer.bar", { variant: "composer", placeholder: reason ?? "\u53D1\u9001\u6D88\u606F\uFF0C\u7EE7\u7EED\u5267\u60C5\u2026", ...reason ? { blocked: { reason } } : {} }));
        return /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-shell", ref: shell }, props.renderSlot("conversation.session.header", {}), /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-scroll", "data-conversation-scroll": "", ref: scroll }, !payload ? /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-entry" }, error && /* @__PURE__ */ import_react5.default.createElement("p", { role: "alert", className: "tavern-error" }, error), loaded || error ? /* @__PURE__ */ import_react5.default.createElement(ResourceLibrary, { runtime, sessionId: props.sessionId }) : /* @__PURE__ */ import_react5.default.createElement("p", null, "\u6B63\u5728\u8BFB\u53D6\u9152\u9986\u2026")) : /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, session?.blank ? /* @__PURE__ */ import_react5.default.createElement(Opening, { sessionId: props.sessionId, payload, blank: true }) : /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, props.renderSlot("conversation.session", {}), /* @__PURE__ */ import_react5.default.createElement(Opening, { sessionId: props.sessionId, payload })), error && /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-opening" }, /* @__PURE__ */ import_react5.default.createElement("p", { className: "tavern-error", role: "alert" }, error), /* @__PURE__ */ import_react5.default.createElement("button", { onClick: () => runtime.refresh(props.sessionId, true) }, "\u91CD\u65B0\u52A0\u8F7D\u524D\u7AEF")))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "tavern-composer", "data-composer-seat": "", ref: composer }, props.renderSlotChain("conversation.composer", { sessionId: props.sessionId, session, pendingInteraction }, { fallback: bar, overlay: true })));
      }
      function Conversation(props) {
        const preset = props.useSessions((list) => list.byId[props.sessionId]?.projectionValues?.agentPreset);
        return preset === "tavern" ? /* @__PURE__ */ import_react5.default.createElement(TavernConversation, { ...props }) : /* @__PURE__ */ import_react5.default.createElement(Original, { ...props });
      }
      return Conversation;
    });
  });
  ...
  function updateMode() {
    ...
    if (next !== active) {
      active = next;
      if (active) settingsDispose = ctx.slots.inject("settings.section", () => ctx.slots.register({ name: "settings.section", id: "tavern-mode", order: 45, label: () => "\u9152\u9986\u6A21\u5F0F" }, (props) => /* @__PURE__ */ import_react5.default.createElement(Settings, { ...props, scope: "global" })));
      else {
        settingsDispose?.();
