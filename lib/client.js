...
function createBrowserRuntime(ctx) {
  ...
  return {
    ...
    setRunning(id, generating) {
      ...
      if (payload && payload.generating !== generating) publish(id, { payload: { ...payload, generating } });
    },
  ...
  ctx.slots.inject("conversation.chat.node", () => {
    ...
    return bindComponent(original, (Original) => {
      function Assistant(props) {
        ...
        if (messageIndex < 0) return /* @__PURE__ */ import_react5.default.createElement(Original, { ...props });
